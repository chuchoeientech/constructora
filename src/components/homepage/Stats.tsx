...
const Stats = () => {
  ...
  return (
    <section id="estadisticas" className="py-32 bg-gradient-to-br from-blue-600 to-blue-800 relative overflow-hidden">
      ...
      <div ref={ref} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white/95 backdrop-blur-sm p-10 rounded-2xl shadow-xl transform hover:scale-105 transition duration-300">
            <Building className="w-14 h-14 text-blue-600 mb-6" />
          ...
          <div className="bg-white/95 backdrop-blur-sm p-10 rounded-2xl shadow-xl transform hover:scale-105 transition duration-300">
            <Construction className="w-14 h-14 text-blue-600 mb-6" />
            <h3 className="text-5xl font-bold text-gray-800 mb-4">
          ...
          <div className="bg-white/95 backdrop-blur-sm p-10 rounded-2xl shadow-xl transform hover:scale-105 transition duration-300">
            <Users className="w-14 h-14 text-blue-600 mb-6" />
            <h3 className="text-5xl font-bold text-gray-800 mb-4">
